                    ...
                    <div className="flex space-x-2 p-2 bg-gray-100">
                      <button
                        ...
                        className={`px-2 py-1 rounded ${
                          editor?.isActive('bold') ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'
                        }`}
                      >
                        Bold
                      </button>
                      <button
                        ...
                        className={`px-2 py-1 rounded ${
                          editor?.isActive('italic') ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'
                        }`}
                      >
                        Italic
                      </button>
                      ...
                      <button
                        ...
                        onClick={handleLink}
                        className={`px-2 py-1 rounded ${
                          editor?.isActive('link') ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'
                        }`}
                      >
                        Link
                      </button>
            ...
            {blogs.map((blog) => (
              ...
              >
                ...
                <div className="px-6 pb-6">
                  ...
                  <div
                    className="text-gray-700 text-sm prose max-w-none text-left"
